...
More than 3 years ago I moved to Novo-Novsk, but worked on new Magnetic Storage for last 40. When I was 8... \n''', 'ru'),('78 '+ '- ' + translit(num2words(78, lang='en'), 'ru')), ('15 ' + '- ' + translit(num2words(15,lang='en'), 'ru')), ('3 ' + '- ' + translit(num2words(3, lang='en'),'ru')),('40 ' + '- ' + translit(num2words(40, lang='en'), 'ru')),('8 ' + '- ' + translit(num2words(8, lang='en'), 'ru')), sep='\n')
